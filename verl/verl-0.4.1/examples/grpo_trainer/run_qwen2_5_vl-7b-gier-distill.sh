...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=../../data/GIER_distill/Pick-20250714-174542/distill_data_train.parquet \
    data.val_files=../../data/GIER_distill/Pick-20250714-174542/distill_data_test.parquet \
    ...
    trainer.project_name='verl_grpo_example_gier' \
