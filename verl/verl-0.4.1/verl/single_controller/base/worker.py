...
class Worker(WorkerHelper):
    ...
    def _setup_env_cuda_visible_devices(self):
        ...
        print(f"HIP_VISIBLE_DEVICES: {hip_val}")
        cuda_val = os.environ.get("CUDA_VISIBLE_DEVICES", None)
        print(f"CUDA_VISIBLE_DEVICES: {cuda_val}")
        
        if hip_val:
            print("HIP_VISIBLE_DEVICES is set, as well as CUDA_VISIBLE_DEVICES. Ignoring HI_VISIBLE_DEVICES.")
            ...
            #     print(f"Please use the same HIP_VISIBLE_DEVICES or CUDA_VISIBLE_DEVICES, inconsistant values found: {val} and {cuda_val}. Using {val} as CUDA_VISIBLE_DEVICES.")
            #     cuda_val = val
        ...
        if rocr_val:
            print("ROCR_VISIBLE_DEVICES is set, as well as CUDA_VISIBLE_DEVICES. Ignoring ROCR_VISIBLE_DEVICES.")
